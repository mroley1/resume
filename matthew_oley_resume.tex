...
\begin{document}
\name{Matthew Oley}
\tagline{Third Year Student at RIT seeking Summer CO-OP}
...
% Development Tasks, Automated Testing, Ada Compliance, Software Engineer, Web Standards, Containerization, Requirements Gathering, Audio Processing, User Interface, Software Development, Web Development, Diagramming, Typescript, Javascript, Windows, Mongodb, Python, C/c++, Agile, Linux, Sass, Rust, Html, Java, Uml, Git, Sql, Css, C#, Github, Angular, Software Engineering, Designer, Web Designer, Computer Science
