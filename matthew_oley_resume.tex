...
\begin{document}
\name{Matthew Oley}
\tagline{Second Year Student at RIT seeking summer CO-OP}
...
\cvschool{Bachelor of Science in Software Engineering}{Rochester Institute of Technology}{Anticipated May 2027}{}{Honors Program}{3.85 GPA}
...
\smallskip
\cvsection{Leadership and Involvment}
\columnratio{0.25}
\begin{paracol}{4}
...
\switchcolumn[3]
\cvachievement{\faCode}{Google Developer\newline Student Clubs}{Member}
%%begin novalidate
\end{paracol}
%%end novalidate
...
\cvevent{Carpenter}{National Technical Institute for the Deaf Performing Arts}{Jan 2023 -- Present}{Rochester, NY}{}{}
\begin{itemize}
